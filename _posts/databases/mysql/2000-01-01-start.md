...
If using a Business plan for your MySQL addon, we setup a MySQL cluster. This
...
{% note %}
Databases using version 5.5.54-1 or earlier do not have TLS support.
{% endnote %}
...
- `agora-fr1`: [https://phpmyadmin.agora-fr1.scalingo.com](https://phpmyadmin.agora-fr1.scalingo.com).
